...
module.exports = _module = {
    ...
    sample: function sample(data, size) {
        var results = [];
        if (!size) {
            size = 1;
        }
    ...
    make_numeric_id: function make_numeric_id() {
        return _module.sample(NUMERIC, 6);
    },
    make_success: function make_success() {
    ...
    make_tr: function make_tr(baseDate, force) {
    ...
    randomWords: function randomWords(numberofWords) {
    ...
    toDateString: function toDateString(date) {
    ...
    formatText: function formatText(text, values) {
