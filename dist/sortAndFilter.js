...
var compare = {
    ...
    'minDate': function minDate(l, r) {
        return new Date(l) >= new Date(r);
    },
    'maxDate': function maxDate(l, r) {
        return new Date(l) <= new Date(r);
    },
    'in': function _in(l, r) {
    ...
    'notcontains': function notcontains(l, r) {
        //console.log("notcontains", arguments);
        return Array.isArray(l) || typeof l === "string" ? l.indexOf(r) === -1 : false;
    },
    'containsatleastone': function containsatleastone(l, r) {
    ...
    "startsWithCI": function startsWithCI(l, r) {
...
module.exports = _module = {
    get_type: function get_type(fields, field) {
    ...
    sort: function sort(data, type, sort_column, sort_order) {
        var asc;
        if (sort_column != null) {
                ...
                if (a[sort_column] === undefined) {
                    ...
                    switch (type) {
                        ...
                        case "checkbox":
                            ...
                            break;
                        default:
                            result = a[sort_column].toString().localeCompare(b[sort_column].toString());
                            break;
                    }
                }
                return asc * result;
    ...
    // search box
    filter: function filter(data, search) {
    ...
    // filter for columns
    filter_columns: function filter_columns(data, filters) {
        if (filters != null) {
            return data.filter(function (item) {
                return Object.keys(filters).reduce(function (prev, filter) {
                    return prev && _module.filter_switch(item, filter, filters[filter]);
                }, true);
            });
        }
        return data;
    },
    filter_switch: function filter_switch(item, filterId, filter) {
        // change simple filter to complex filter if needed
        if (Array.isArray(filter) || (typeof filter === 'undefined' ? 'undefined' : _typeof(filter)) !== "object") {
    ...
    search: function search(data, options, callback) {
...
//# sourceMappingURL=sortAndFilter.js.map