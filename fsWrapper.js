...
module.exports = {
    jsonToFileSync: function jsonToFileSync(fileName, json) {
        var strJson = JSON.stringify(json, null, 4);
        fs.writeFileSync(fileName, strJson);
    },
    fileToJsonSync: function fileToJsonSync(fileName) {
        try {
    ...
    jsonToFile: function jsonToFile(filename, json, callback) {
        try {
            if (json !== undefined) {
    ...
    fileToJson: function fileToJson(filename, callback) {
        try {
